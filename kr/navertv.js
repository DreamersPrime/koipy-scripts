...
function requireHashes () {
	if (hasRequiredHashes) return hashes.exports;
	hasRequiredHashes = 1;
		...
		(function() {
		  ...
		  Hashes = {
		    ...
		    RMD160: function(options) {
		      (options && typeof options.uppercase === 'boolean') ? options.uppercase : false;
		        var b64pad = (options && typeof options.pad === 'string') ? options.pa : '=',
		        utf8 = (options && typeof options.utf8 === 'boolean') ? options.utf8 : true,
		        rmd160_r1 = [
	...
	return hashes.exports;
}

var hashesExports = requireHashes();

function handler() {
    const timestamp = Date.now();
    const signature = new hashesExports.SHA1().b64_hmac("nbxvs5nwNG9QKEWK0ADjYA4JZoujF4gHcIwvoCxFTPAeamq5eemvt5IWAYXxrbYM", `https://apis.naver.com/now_web2/now_web_api/v1/clips/31030608/play-info${timestamp}`);
    println("[Naver TV] timestamp: " + timestamp);
    println("[Naver TV] signature: " + signature);
    const requestUrl = `https://apis.naver.com/now_web2/now_web_api/v1/clips/31030608/play-info?msgpad=${timestamp}&md=${encodeURIComponent(signature)}`;
